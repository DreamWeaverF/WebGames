...
{
    [CustomEditor(typeof(FImage), true)]
    [CanEditMultipleObjects]
    public class FImageEditor : ImageEditor
    {
        private FImage m_target;
        public override void OnInspectorGUI()
        {
            m_target = (FImage)target;
            base.OnInspectorGUI();

            EditorGUILayout.BeginHorizontal();
            SerializedProperty spritePool = serializedObject.FindProperty("m_spritePool");
            EditorGUILayout.PropertyField(spritePool);
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            SerializedProperty spriteAddresss = serializedObject.FindProperty("m_spriteAddresss");
            EditorGUILayout.PropertyField(spriteAddresss);
            EditorGUILayout.EndHorizontal();
